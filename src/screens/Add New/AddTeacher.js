    ...
    return (
        <>
            ...
            <ScrollView contentContainerStyle={styles.container}>
                ...
                <Input label="Date of Joining" value={formData.subject} onChange={val => handleChange('subject', val)} />
                ...
                <Input label="Education" value={formData.class} onChange={val => handleChange('class', val)} />
                <Input label="National ID" value={formData.class} onChange={val => handleChange('class', val)} />
                <Input label="Home Address" value={formData.class} onChange={val => handleChange('class', val)} />
                <Input label="Experience" value={formData.class} onChange={val => handleChange('class', val)} />
