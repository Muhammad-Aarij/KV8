...
const styles = StyleSheet.create({
    ...
    badge: { backgroundColor: theme.colors.blue, paddingHorizontal: 9, paddingVertical: 5.5, borderRadius: 5,position:"absolute",top:0, right: 4 },
    badgeText: { fontFamily: "Urbanist-SemiBold", color: '#fff', fontSize: 10, letterSpacing: 0.5 },
